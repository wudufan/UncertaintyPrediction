...
python3 train_uncertainty.py "./config/uncertainty/l2_depth_4.cfg" --Train.device "'0'" \
--IO.tag "'l2_depth_4/img_drop_0.1'" \
...
&> ./outputs/uncertainty/l2_depth_4/img_drop_0.1.log &

python3 train_uncertainty.py "./config/uncertainty/l2_depth_4.cfg" --Train.device "'1'" \
--IO.tag "'l2_depth_4/patch_drop_0.1'" \
...
&> ./outputs/uncertainty/l2_depth_4/patch_drop_0.1.log &
wait