...
if sys.argv[0] != 'test_denoising_h5.py':
    print ('debugging', flush=True)
    args = parser.parse_args(['--dataset', '/home/dwu/trainData/deep_denoiser_ensemble/data/mayo_2d_3_layer_mean/dose_rate_4.h5', 
                          '--checkpoint', '/home/dwu/trainData/deep_denoiser_ensemble/train/mayo_2d_3_layer_mean/l2_depth_3/dose_rate_4/25.h5',
                          '--output_dir', '/home/dwu/trainData/uncertainty_prediction/denoising_results/mayo_2d_3_layer_mean/l2_depth_3/dose_rate_4/',
                        ])
    verbose = 1
else:
